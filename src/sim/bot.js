...
import { createInput, eyePosition, aimDirection } from './sim.js?v=666ddf9a';
import { hasLineOfSight } from './world.js?v=666ddf9a';
import { distXZ, clamp } from './math.js?v=666ddf9a';
