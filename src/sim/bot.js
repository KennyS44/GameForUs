...
import { createInput, eyePosition, aimDirection } from './sim.js?v=de5ae533';
import { hasLineOfSight } from './world.js?v=de5ae533';
import { distXZ, clamp } from './math.js?v=de5ae533';
