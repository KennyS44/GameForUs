...
import { createInput, eyePosition, aimDirection } from './sim.js?v=d3e89d2a';
import { hasLineOfSight } from './world.js?v=d3e89d2a';
import { distXZ, clamp } from './math.js?v=d3e89d2a';
