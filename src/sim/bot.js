...
import { createInput, eyePosition, aimDirection } from './sim.js?v=b14bea4c';
import { hasLineOfSight } from './world.js?v=b14bea4c';
import { distXZ, clamp } from './math.js?v=b14bea4c';
