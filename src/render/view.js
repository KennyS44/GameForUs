...
import { PLAYER, FLASHLIGHT, WEAPONS, FOV, DEFAULT_WEAPON } from '../sim/constants.js?v=0f7349cc';
import { lerp } from '../sim/math.js?v=0f7349cc';
import { buildWeaponModel } from './weapons.js?v=0f7349cc';
