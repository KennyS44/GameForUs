...
import { createInput, eyePosition, aimDirection } from './sim.js?v=4947c3af';
import { hasLineOfSight } from './world.js?v=4947c3af';
import { distXZ, clamp } from './math.js?v=4947c3af';
