...
import { createInput, eyePosition, aimDirection } from './sim.js?v=0f7349cc';
import { hasLineOfSight } from './world.js?v=0f7349cc';
import { distXZ, clamp } from './math.js?v=0f7349cc';
