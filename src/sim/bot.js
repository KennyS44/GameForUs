...
import { createInput, eyePosition, aimDirection } from './sim.js?v=9414b459';
import { hasLineOfSight } from './world.js?v=9414b459';
import { distXZ, clamp } from './math.js?v=9414b459';
