...
import { createInput, eyePosition, aimDirection } from './sim.js?v=3d9441b4';
import { hasLineOfSight } from './world.js?v=3d9441b4';
import { distXZ, clamp } from './math.js?v=3d9441b4';
import { BLIND, GADGETS } from './constants.js?v=3d9441b4';
